<form action="#" method="post">
      <div class="card mt-3">
                            ...
                            <?php
                              foreach ($catalog as $ctl){
                                ...
                                <th scope="row"><p class="example"><input type="checkbox" class="chonX" name="chonX[]"></p></th> 
                                        ...
                                        <td>'.$name.'</td>
                                        <td>
                                        <a href="index.php?act=catalog&id='.$id.'" class="btn btn-warning">Xoá</a>
                                        <a href="index.php?act=catalog&ctrl=edit&id='.$id.'" class="btn btn-info">Sửa</a>
                                        </td>               
                                </tr>
                                            ';
        ...
        <div class="card-footer">
            ...
            <a href="index.php?act=catalog&ctrl=addnew" class="btn btn-info">Thêm mới</a>
        </div>
      </div>
