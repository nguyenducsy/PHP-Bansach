...
<form action="header.php?act=product" method="post">
      <div class="card mt-3">
                            ...
                            <?php
                              ...
                              foreach ($product as $prd){
                                ...
                                <th scope="row"><p class="example"><input type="checkbox" class="chonX" name="chonX[]"></p></th> 
                                        ...
                                        <td>
                                        <a href="admin.php?act=product&ctrl=delete&id='.$id.'" class="btn btn-warning">Xoá</a>
                                        <a href="admin.php?act=product&ctrl=edit&id='.$id.'" class="btn btn-info">Sửa</a>
                                        </td>               
                                </tr>
                                            ';
        ...
        <div class="card-footer">
          ...
          <!-- <a href="#" class="btn btn-info">  <button  class="example" onclick="selectall()"   >Chọn tất cả</button> </a> -->
            ...
            <a href="admin.php?act=product&ctrl=addproduct" class="btn btn-info">Thêm mới</a>
        </div>
      </div>
