...
?>
    <div class="box_content">
      ...
      <div class="box_head">
                ...
                <div class="box_logo"> <strong>WAK<span>A</span>DMIN</strong> </div>
                <div class="box_note">
                    <?php
                        foreach($number as $n){
                            $mess = $n['mess'];
                ...
                <div class="box_logout"><span>Logout</span></div>
      ...
      <div class="box_left">
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <a class="nav-link dropdown-toggle" href="index.php?act=catalog" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fas fa-user-friends"></i>
                            <span>Category manager</span>
                  </a>  
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="header.php?act=catalog">Home</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="header.php?act=catalog&ctrl=addnew">Add-new</a>
  
                  </div>
              </li>
            
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="header.php?act=product" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fa fa-shopping-cart"></i>
                            <span>Product manager</span>
                  </a>  
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="header.php?act=product">Home</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="header.php?act=product&ctrl=addproduct">Add-new</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="index.php?act=product&ctrl=addproduct" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class=" fa fa-bar-chart-o"></i>
                            <span>Charts</span>
                         </a>  
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="header.php?act=thongke">Home</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="header.php?act=thongke&ctrl=chart">Chart</a>
                        </div>  
                   </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
