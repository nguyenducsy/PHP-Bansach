...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../view/css/zabuto_calendar.css">
    <link rel="stylesheet" type="text/css" href="../view/css/jquery.gritter.css" />
...
<body>
    <div class="box_noidung">
      ...
      <div style=" display:block "  class="row mt">
                                ...
                                <div class="message-p pn">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 centered hidden-sm hidden-xs">
                                            <img src="../view/img/ui-danro.jpg" class="img-circle" width="65">
                                        </div>
                                        <div class="col-md-9">
                                            <p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb">
                                ...
                                <div class="white-panel pn">
                                    ...
                                    <p><img src="../view/img/ui-zac.jpg" class="img-circle" width="50"></p>
                                    <p><b>Zac Snider</b></p>
                                    <div class="row">
                                        <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                <div class="product-panel-2 pn">
                                    ...
                                    <img src="../view/img/product.jpg" width="200" alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                <div class="content-panel pn">
                                    <div id="profile-02">
                                        <div class="user">
                                            <img src="../view/img/friends/fr-06.jpg" class="img-circle" width="80">
                                            <h4>DJ SHERMAN</h4>
                                        </div>
                                    </div>
